...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app/modules/cart/cart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = createCartSection;
var _cart = _interopRequireDefault(require("./cart.html"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function createCartSection() {
  var cartElement = document.createElement('div');
  cartElement.classList.add('cart');
  cartElement.innerHTML = _cart.default;
  document.body.appendChild(cartElement);
}
},{"./cart.html":"app/modules/cart/cart.html"}],"app/modules/header/header.js":[function(require,module,exports) {
"use strict";
...
var _header = _interopRequireDefault(require("./header.html"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function createHeader() {
  var headerElement = document.createElement('header');
  headerElement.classList.add('header');
  headerElement.innerHTML = _header.default;
  document.body.appendChild(headerElement);
  return headerElement;
}
},{"./header.html":"app/modules/header/header.html"}],"../node_modules/ssr-window/ssr-window.esm.js":[function(require,module,exports) {
"use strict";
...
function createBannerSection() {
  var bannerElement = document.createElement("section");
  bannerElement.classList.add("banner");
  bannerElement.innerHTML = _banner.default;
  return bannerElement;
}
var bannerSwiper = new _swiper.default(".swiper-container", {
  modules: [_swiper.Parallax, _swiper.Pagination, _swiper.Mousewheel, _swiper.Autoplay, _swiper.Scrollbar, _swiper.Keyboard],
  direction: "vertical",
  speed: 1000,
  parallax: true,
  loop: true,
...
exports.bannerSwiper = bannerSwiper;
},{"./banner.html":"app/modules/banner/banner.html","swiper":"../node_modules/swiper/swiper.esm.js"}],"app/modules/cards/cards.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = createCardsSection;
var _cards = _interopRequireDefault(require("./cards.html"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function createCardsSection() {
  var cardsElement = document.createElement('section');
  cardsElement.classList.add('cards');
  cardsElement.innerHTML = _cards.default;
  return cardsElement;
}
},{"./cards.html":"app/modules/cards/cards.html"}],"app/modules/banner/slideNumbe.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = slideNumder;
function slideNumder(bannerSwiper) {
  bannerSwiper.on('slideChange', function () {
    var realIndex = bannerSwiper.realIndex;
    var slideNumberElement = document.getElementById('slideNumber');
    slideNumberElement.textContent = realIndex + 1;
  });
  var scrollbarContainer = document.querySelector('.swiper-scrollbar');
  scrollbarContainer.addEventListener('scroll', function () {
    var slideWidth = bannerSwiper.slides[0].getWidth();
    var scrollLeft = scrollbarContainer.scrollLeft;
    var currentSlide = Math.round(scrollLeft / slideWidth);
    var slideNumberElement = document.getElementById('slideNumber');
...
},{}],"app/modules/cards/components/buttons/buttons.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = loadMoreCards;
var _card = _interopRequireDefault(require("../../card.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function loadMoreCards() {
  var loadedCards = 8;
  var loadButton = document.querySelector('.button__load');
  function additionalCards() {
    fetch('https://6464831d043c103502bb5293.mockapi.io/api/terminators').then(function (response) {
      return response.json();
    }).then(function (data) {
      var remainingCards = data.slice(loadedCards, loadedCards + 8);
      remainingCards.forEach(function (terminator) {
...
},{"../../card.js":"app/modules/cards/card.js"}],"app/modules/header/components/inputs/input.js":[function(require,module,exports) {
"use strict";
...
;
},{}],"app/modules/cards/components/buttons/buttonEye.js":[function(require,module,exports) {
"use strict";
...
function buttonEye(cardsSection) {
  if (!cardsSection) {
    return;
  }
  cardsSection.addEventListener('click', function (event) {
    var buttonEye = event.target.closest('.button__eye');
    if (buttonEye) {
      var photoCardItemLink = buttonEye.dataset.src;
...
},{}],"app/modules/header/components/buttons/openCart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = openCart;
function openCart() {
  var cartDiv = document.querySelector(".shopping__cart");
  var openCartBtn = document.querySelector(".cart__btn");
  var deleteCartBtn = document.querySelector(".shopping__cart-close");
  var overlay = document.querySelector(".cart__overlay");
  var parentElement = document.getElementById('cart__btn');
  var sectionElement = document.getElementById('cart-box');
  ...
  document.addEventListener("click", function (event) {
    var deleteCartItemButton = event.target.closest('.shopping__cart-delete-item');
...
},{}],"app/modules/cards/components/buttons/buttonBuy.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function buttonBuy(event, cardsSection) {
  if (!cardsSection) {
    return;
  }
  var cartItems = getCartItemsFromStorage();
  cartItems.forEach(function (cartItem) {
    return addToCartElement(cartItem);
  });
  ...
  cardsSection.addEventListener('click', function (event) {
    var addToCartButton = event.target.closest('.button__basket');
    if (addToCartButton) {
      var buttonId = addToCartButton.id;
      addToCart(buttonId);
    }
  });
  setTimeout(function () {
    var deleteAllButton = document.querySelector('.cart-delete-all-btn');
...
function addToCart(buttonId) {
  fetch("https://6464831d043c103502bb5293.mockapi.io/api/terminators/".concat(buttonId)).then(function (response) {
    return response.json();
  }).then(function (data) {
...
function createCartItem(terminator, id) {
  ...
  var cartItemsWrapper = document.createElement('div');
  ...
  var cartItemPrice = document.createElement('h4');
  cartItemPrice.classList.add('item-price');
  cartItemPrice.textContent = "$".concat(terminator.price.toFixed(2));
  var cartDeleteItem = document.createElement("button");
  ...
  cartDeleteItem.addEventListener('click', function (event) {
    ...
    var buttonId = cartItem.dataset.id;
...
function addToCartElement(data) {
  if (data.hasOwnProperty('id')) {
    var cartItem = createCartItem(data, data.id);
    var buttonId = cartItem.dataset.id;
    setTimeout(function () {
      var cartContainer = document.getElementById('cart-container');
      var emptyCartMessage = document.getElementById('empty-cart-message');
      if (cartContainer) {
        ...
        saveCartItemToStorage(buttonId, data);
        calculateTotalPrice();
        var _cartItems = getCartItemsFromStorage();
        if (emptyCartMessage && _cartItems.length === 0) {
          emptyCartMessage.style.display = 'flex';
        } else {
          emptyCartMessage.style.display = 'none';
        }
...
function getCartItemsFromStorage() {
  var serializedCartItems = localStorage.getItem('cartItems');
...
function calculateTotalPrice() {
  ...
  var totalSumElement = document.querySelector('.shopping__cart-footer-sum');
  totalSumElement.textContent = "$".concat(totalPrice.toFixed(2));
}
...
var _cart = _interopRequireDefault(require("./app/modules/cart/cart.js"));
var _header = _interopRequireDefault(require("./app/modules/header/header.js"));
var _banner = _interopRequireWildcard(require("./app/modules/banner/banner.js"));
var _cards = _interopRequireDefault(require("./app/modules/cards/cards.js"));
var _slideNumbe = _interopRequireDefault(require("./app/modules/banner/slideNumbe.js"));
var _buttons = _interopRequireDefault(require("./app/modules/cards/components/buttons/buttons.js"));
var _input = _interopRequireDefault(require("./app/modules/header/components/inputs/input.js"));
var _buttonEye = _interopRequireDefault(require("./app/modules/cards/components/buttons/buttonEye.js"));
var _openCart = _interopRequireDefault(require("./app/modules/header/components/buttons/openCart.js"));
var _buttonBuy = _interopRequireDefault(require("./app/modules/cards/components/buttons/buttonBuy.js"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function init() {
  (0, _header.default)();
  createMainSection();
  _banner.bannerSwiper.init();
  (0, _slideNumbe.default)(_banner.bannerSwiper);
  (0, _buttons.default)();
  (0, _input.default)();
  (0, _cart.default)();
  (0, _openCart.default)();
...
function createMainSection() {
  ...
  var bannerSection = (0, _banner.default)();
  var cardsSection = (0, _cards.default)();
  mainElement.appendChild(bannerSection);
  mainElement.appendChild(cardsSection);
  document.body.appendChild(mainElement);
  (0, _buttonEye.default)(cardsSection);
  (0, _buttonBuy.default)(event, cardsSection);
}
init();
},{"./app/modules/cart/cart.js":"app/modules/cart/cart.js","./app/modules/header/header.js":"app/modules/header/header.js","./app/modules/banner/banner.js":"app/modules/banner/banner.js","./app/modules/cards/cards.js":"app/modules/cards/cards.js","./app/modules/banner/slideNumbe.js":"app/modules/banner/slideNumbe.js","./app/modules/cards/components/buttons/buttons.js":"app/modules/cards/components/buttons/buttons.js","./app/modules/header/components/inputs/input.js":"app/modules/header/components/inputs/input.js","./app/modules/cards/components/buttons/buttonEye.js":"app/modules/cards/components/buttons/buttonEye.js","./app/modules/header/components/buttons/openCart.js":"app/modules/header/components/buttons/openCart.js","./app/modules/cards/components/buttons/buttonBuy.js":"app/modules/cards/components/buttons/buttonBuy.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("html",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/html-loader.js"));b.load([["cart.b7bc962b.html","app/modules/cart/cart.html"],["header.4ab81304.html","app/modules/header/header.html"],["banner.e4a2a103.html","app/modules/banner/banner.html"],["cards.1dbb4373.html","app/modules/cards/cards.html"]]).then(function(){require("app.js");});
